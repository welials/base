...
В дизайне намеренно снижена концептуальная ясность использования awaitради повышения производительности. Каждый раз, когда ожидается выполнение задачи, 
управление необходимо передать по всему стеку вызовов, вплоть до цикла обработки событий. Это может показаться мелочью, 
но в большой программе с большим количеством await' и глубоким стеком вызовов такие накладные расходы могут существенно снизить производительность.
"""